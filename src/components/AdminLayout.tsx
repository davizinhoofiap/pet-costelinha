        ...
        <div>
          ...
          <nav className="p-2 space-y-1">
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="bg-emerald-500 text-white font-mono text-[10px] px-1.5 py-0.5 rounded-full font-bold">
                  {unreadCount}
                </span>
              )}
            </Link>
                ...
                <div className="p-3.5 bg-slate-900 text-white flex justify-between items-center">
                  ...
                  {unreadCount > 0 && (
                    <button
                      ...
                      className="text-[10px] bg-slate-800 hover:bg-slate-700 text-slate-300 px-2 py-0.5 rounded font-medium flex items-center gap-1"
                    >
